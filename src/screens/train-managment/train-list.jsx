          ...
          >
            <Row className="justify-content-center mb-3">
              <Col className="col-auto">
                <h2 style={{ color: "green" }}>Trains</h2>
              </Col>
            </Row>
            <Row className="justify-content-center mb-3">
              <Col sm={12} md={6} lg={8}>
            ...
            <Modal.Body>
              {selectedTrain && (
                <div>
                  ...
                  <br />
                  <strong>First Class Reserved Tickets:</strong>{" "}
                  {selectedTrain.firstClassTicketsReserved &&
                  selectedTrain.firstClassTicketsReserved
                    ? selectedTrain.firstClassTicketsReserved
                    : "0"}
                  <br />
                  <strong>Second Class Reserved Tickets:</strong>{" "}
                  {selectedTrain.secondClassTicketsReserved &&
                  selectedTrain.secondClassTicketsReserved
                    ? selectedTrain.secondClassTicketsReserved
                    : "0"}
                  <br />
                  <strong>Third Class Reserved Tickets:</strong>{" "}
                  {selectedTrain.thirdClassTicketsReserved &&
                  selectedTrain.thirdClassTicketsReserved
                    ? selectedTrain.thirdClassTicketsReserved
                    : "0"}
                  <br />
          ...
          <Modal show={showDeleteModal} onHide={closeDeleteModal}>
            ...
            <Modal.Body>
              {selectedTrain && (
                <div>
                  <p>
                    Are you sure you want to cancel the train "
                    {selectedTrain.name}
                    "?
                  </p>
                </div>
